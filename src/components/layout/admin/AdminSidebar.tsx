      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-2 space-y-1">
          ...
          <button
            ...
            className={`flex items-center gap-2 w-full px-3 py-2 text-xs font-semibold text-primary uppercase tracking-wider hover:text-admin-ash-2 transition-colors ${collapsed ? 'lg:justify-center' : ''}`}
          >
                  ...
                  <Link
                    ...
                    className={`
                      ...
                      ${active
                        ...
                        : 'text-black hover:bg-primary/10 hover:text-black'
                      }
                    `}
                  >
          ...
          <button
            ...
            className={`
              group relative flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium
              text-black hover:bg-admin-danger-light hover:text-admin-danger transition-all duration-200 w-full text-left
              ${collapsed ? 'lg:justify-center lg:px-2' : ''}
            `}
          >
