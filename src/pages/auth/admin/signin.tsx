...
export default function Signin() {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-screen">
            ...
            <div className="lg:w-[42%] xl:w-[40%] lg:flex min-h-[43vh]  md:min-h-[68vh] justify-center items-center flex-col lg:min-h-screen relative overflow-hidden bg-primary-dark">
                {/* Content */}

                <div className="relative z-10 flex flex-col justify-center w-full h-full items-start mt-8 md:mt-1 mb-8 lg:mb-0 lg:mt-0 px-12 xl:px-16">
                ...
                <div className="w-full max-w-md ">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-[#6b7280]">
                            Sign in with your work email and admin credentials.
                        </p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-[#6b7280]">
                        Need access ?{' '}
                        <Link to="/admin/signup" className="font-semibold text-[#34C759] hover:text-[#2eb14f] transition-colors">
