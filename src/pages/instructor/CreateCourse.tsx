...
export default function CreateCourse() {
  ...
  return (
    <div className="min-h-screen px-10 py-4">
      ...
      <h1 className="text-xl font-bold text-[#202020]">Create a course</h1>
      ...
      <div className="w-full max-w-[760px] rounded-xl bg-white">
        <h2 className="text-xl font-semibold text-[#4D4D4D]">Course Details</h2>
        ...
        <div className="mb-10 relative">
          ...
          >
            <span
              className={`text-[15px] ${
                courseDuration ? "text-[#202020]" : "text-[#B5B5B5]"
              }`}
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-[620px] rounded-3xl bg-white p-10 shadow-2xl">
            ...
            <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-full border-2 border-[#17823B]">
              <Check size={38} strokeWidth={3} className="text-[#17823B]" />
            </div>
            ...
            <p className="mx-auto mt-4 max-w-[430px] text-center text-[16px] leading-7 text-[#8A8A8A]">
              Your course has been successfully published. You can now return to
              your dashboard or continue building your course.
            </p>
